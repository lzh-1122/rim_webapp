                    ...
                    <el-col :span="11">
                        <div class="grid-content bg-purple">
                            ...
                            <el-row :gutter="10">
                                ...
                                <el-col :span="12">
                                    <div class="grid-content bg-purple-dark">
                                        <RIMValueTable :tbl-data="getForecast()" tbl-title="分析师预测"></RIMValueTable>
                                    </div>
                                </el-col>
                            </el-row>
                        </div>
                    ...
                    <el-col :span="8">
                        <div class="grid-content bg-purple" v-if="rData != null">
                            <RIMValueSlider :config-info="get_configT1_T2()"
                                            :caption-fn="v=>'EPS增长期'+v+'年， ROE均值回归期'+(rData['t1_t2']-v) + '年'"
                                            @func="getValueT1T2FormSon"></RIMValueSlider>
                            <RIMValueSlider :config-info="get_configR()" :caption-fn="v=>'投入资本回报率'+v * 100+'%'"
                                            @func="getValueRFormSon"></RIMValueSlider>
                            <RIMValueSlider :config-info="get_configG1()" :caption-fn="v=>'EPS增长期的增长率'+v * 100+'%'"
                                            @func="getValueG1FormSon"></RIMValueSlider>
                            <RIMValueSlider :config-info="get_configG2()" :caption-fn="v=>'持续经营期剩余收益增长率'+v * 100+'%'"
                                            @func="getValueG2FormSon"></RIMValueSlider>
                        </div>
                    </el-col>
                </el-row>
            </div>
